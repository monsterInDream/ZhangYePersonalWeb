...
import avatarImage from '../assets/avatar_icon.png'

export function renderContactLayout() {
    return `
      <div class="relative w-screen h-screen bg-[#ffffff]">
        ...
        <div class="flex flex-row items-center w-full h-fit bg-transparent left-0 top-0">
          <img src="${logoImage}" id="contact-logo" alt="Logo" class="w-7 sm:w-8 md:w-9 lg:w-10 h-5 sm:h-6 md:h-7 lg:h-8 ml-10 sm:ml-15 md:ml-20 lg:ml-25 mt-6 sm:mt-9 md:mt-12 lg:mt-15 mb-6 sm:mb-9 md:mb-12 lg:mb-15">
          <img src="${closeImage}" id="close-button" alt="Close" class="w-7 sm:w-8 md:w-9 lg:w-10 h-7 sm:h-8 md:h-9 lg:h-10 ml-auto mr-10 sm:mr-15 md:mr-20 lg:mr-25 mt-6 sm:mt-9 md:mt-12 lg:mt-15 mb-6 sm:mb-9 md:mb-12 lg:mb-15">
        </div>
        ...
        <div class="flex items-center w-full h-fit -mt-9 sm:-mt-12 md:-mt-15 lg:-mt-18 bg-transparent">
            ...
            <img src="${avatarImage}" alt="Avatar" class="w-10 sm:w-15 md:w-20 lg:w-25 h-12 sm:h-20 md:h-25 lg:h-30 rounded-full"/>
            <div class="flex-1 h-px translate-y-1.5 sm:translate-y-3 md:translate-y-3.5 lg:translate-y-4 bg-[#750FF7]"></div>
        </div>
